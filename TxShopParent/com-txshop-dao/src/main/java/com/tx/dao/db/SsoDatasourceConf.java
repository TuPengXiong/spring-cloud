...
public class SsoDatasourceConf {
	...
	SqlSessionFactory sqlSessionFactory(@Qualifier("ssoDataSource") DataSource dataSource) throws Exception{
    ...
    @Bean(name="ssoGlobalConfiguration")
	GlobalConfiguration globalConfiguration(@Qualifier("ssoSqlSessionFactory") SqlSessionFactory sqlSessionFactory){
