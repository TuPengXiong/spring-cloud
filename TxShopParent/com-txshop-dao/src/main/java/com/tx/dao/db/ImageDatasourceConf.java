...
public class ImageDatasourceConf {
	...
	SqlSessionFactory sqlSessionFactory(@Qualifier("imageDataSource") DataSource dataSource) throws Exception{
	...
	@Bean(name="imageGlobalConfiguration")
	GlobalConfiguration globalConfiguration(@Qualifier("imageSqlSessionFactory") SqlSessionFactory sqlSessionFactory){
