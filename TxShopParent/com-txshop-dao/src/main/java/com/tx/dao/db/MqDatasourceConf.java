...
public class MqDatasourceConf {
	...
	SqlSessionFactory sqlSessionFactory(@Qualifier("mqDataSource") DataSource dataSource) throws Exception{
    ...
    @Bean(name="mqGlobalConfiguration")
	GlobalConfiguration globalConfiguration(@Qualifier("mqSqlSessionFactory") SqlSessionFactory sqlSessionFactory){
